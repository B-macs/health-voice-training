...
UI_STRINGS = {
    "de": {
        ...
        "training_plan_complete_title": "10-Tage-Stimmtraining abgeschlossen!",
        "training_plan_complete_body": "Gut durchgehalten. Sieh dir im Tab \"Details\" an, wie sich dein Trend über diese 10 Tage entwickelt hat, und besprich den nächsten Block mit deiner HNO- oder Sprachtherapie-Fachperson.",
        ...
        "training_library_title": "Trainingsbibliothek",
        "training_library_subtext": "Optionale Übung. Das Starten hier verändert weder deinen Tagesplan noch XP, Serie oder Fortschritt.",
        "training_library_filter_label": "Kategorie",
        "training_library_all_categories": "Alle Aktivitäten",
        "training_library_start_button": "Separat üben",
        "training_library_empty": "Für diese Kategorie sind keine Aktivitäten verfügbar.",
        ...
        "activity_library_complete_subtext": "Optionale Übung abgeschlossen. Dein Tagesplan, XP, Serie und Fortschritt bleiben unverändert.",
    ...
    "en": {
        ...
        "training_plan_complete_title": "10-Day Voice Plan Complete!",
        "training_plan_complete_body": "Nice work sticking with it. Head to the Details tab to review your trend across these 10 days, then use ENT or speech-language-pathologist guidance before changing the program.",
        ...
        "training_library_subtext": "Optional practice. Starting an activity here does not change today's plan, XP, streak, or progress.",
        "training_library_filter_label": "Category",
        "training_library_all_categories": "All activities",
        "training_library_start_button": "Practice separately",
        "training_library_empty": "No activities are available for this category.",
        ...
        "activity_library_complete_subtext": "Optional practice complete. Today's plan, XP, streak, and progress are unchanged.",
